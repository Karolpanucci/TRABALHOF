        ...
        <div className=" flex border  border-gray-200 w-96  bg-cyan-500 text-white  transition-colors "><p className=" mt-3 ml-20 flex"> <Candy/> <Link href="/cadastro" className="">Sobre Nossos Produtos</Link></p></div>
